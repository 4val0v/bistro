...
class VkAuth
{
    ...
    {
        $this->client_id='5650793'; // ID приложения
        $this->client_secret = '7WCVAuJCACeWShSqcK0M'; // Защищённый ключ
        $this->redirect_uri = 'https://dengi-bistro.ru/krediti/'.$alias.'.html?ufrom=vk'; // Адрес сайта
    }
