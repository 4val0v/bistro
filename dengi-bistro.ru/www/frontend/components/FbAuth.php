...
class FbAuth
{
    ...
    {
        $this->client_id='1768169246789290'; // ID приложения
        $this->client_secret = '7379406dfd7f39e1ac55009f5c3febef'; // Защищённый ключ
        //$this->redirect_uri = 'http://seostar.require-tests.s-host.net/main/fbauth'; // Адрес сайта
        $this->redirect_uri = 'http://dengi-bistro.ru/krediti/'.$alias.'.html?ufrom=fb';
    }
