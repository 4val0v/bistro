...
<?php Pjax::begin(['id'=>'pjax-first']/*['scrollTo'=>1200]*/);?>
<div class="kf_block">
    <div class="dectop">
...
<?php Pjax::begin(['id'=>'pjax-second','enablePushState' => false, /*'scrollTo'=>100*/]);?>
                    ...
                    <div class="age_right">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                 ...
                                 <?php if($old!=3){?><li><noindex><a rel="nofollow" href="<?=Url::current(['ids'=>$ids, 'old'=>3]);?>">21 год и более</a></noindex></li><?php }?>
                            </ul>
                        </div>
                    </div>
                    <div class="clearfix"></div>
